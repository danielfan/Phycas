...
\newcommand{\currReleaseSVNBuild}{1322}			% TODO: CHECK PRIOR TO NEW RELEASE
...
%
. Why would you want to save your model? It is necessary to save the model if you are planning to partition your data because the partitioning commands require you to specify a model (e.g. ``m1'') along with the set of sites to which that model applies. You will read more about partitioning in section~\ref{subsec:definingpartitionmodel} on page~\pageref{subsec:definingpartitionmodel}.
