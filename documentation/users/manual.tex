...
% Keep hyperref last among includes\usepackage{hyperref}\hypersetup{backref, urlcolor=blue, colorlinks=true, citecolor=blue, hyperindex=true, 
pdfstartview=FitB, 
...
\section{Phycas settings}\label{sec:phycassettings}
