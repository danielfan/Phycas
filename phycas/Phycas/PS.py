...
class PS(PhycasCommand):
    def __init__(self):
        ...
        PhycasCommand.__init__(self, args, "ps", "Performs path sampling (thermodynamic integration) and steppingstone sampling for purposes of estimating the marginal likelihood of the current model.")
    ...
    def __call__(self, **kwargs):
        ...
        mcmc.ps_simpsons_method = self.simpsons_method
