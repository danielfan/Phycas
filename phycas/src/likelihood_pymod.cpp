...
#error USING_NUMARRAY defined
	...
	class_<phycas::MCMCChainManager, boost::noncopyable, boost::shared_ptr<phycas::MCMCChainManager> >("MCMCChainManagerBase")
		...
		.def("adjustSAMCLevels", &MCMCChainManager::adjustSAMCLevels)
		.def("getSAMCGain", &MCMCChainManager::getSAMCGain)
		.def("getSAMCBest", &MCMCChainManager::getSAMCBest)
		.def("setSAMCBest", &MCMCChainManager::setSAMCBest)
		.def("setSAMCRefTree", &MCMCChainManager::setSAMCRefTree)
		.def("setSAMCLikelihoodOnly", &MCMCChainManager::setSAMCLikelihoodOnly)
		.def("getSAMCCounts", &MCMCChainManager::getSAMCCounts)
		.def("getSAMCLogLevels", &MCMCChainManager::getSAMCLogLevels)
		.def("getSAMCWeights", &MCMCChainManager::getSAMCWeights)
		.def("getSAMCPi", &MCMCChainManager::getSAMCPi)
