...
bool Tree::DebugCheckTree(bool allowDegTwo) const
	{
	...
	while (currNd)
		...
		PHYCAS_ASSERT(tree == this);
		PHYCAS_ASSERT(currNd->prevPreorder == prevNd);
		prevNd = currNd;
		currNd = currNd->nextPreorder;
		}
	...
	tipStorage;			    /**< A stack of pointers to (tip) TreeNode objects */
	internalNodeStorage;	/**< A stack of pointers to (internal) TreeNode objects */
