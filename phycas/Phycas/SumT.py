...
class SumT(PhycasCommand):
    def __init__(self):
        ...
        o.__dict__["_help_order"] = ["log", "trees", "splits", "refdistfile"]
        ...
        refdistf_spec = TextOutputSpec(prefix='refdist', help_str="The file specified by this setting saves reference distribution information for use in the multi-tree generalized stepping-stone method. If set to None, reference distribution output will not be saved to a file.")
