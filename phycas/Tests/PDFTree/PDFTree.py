...
phycas.pdf_scalebar_label_font   = 'Times-Roman'
phycas.pdf_scalebar_label_height = 10
phycas.pdf_ladderize             = 'right'
phycas.pdf_scalebar_position     = 'bottom'
phycas.pdf_page_width            = 8.5
phycas.pdf_page_height           = 11.0
phycas.pdf_line_width            = 2.0
phycas.pdf_left_margin           = 1.0
phycas.pdf_right_margin          = 1.0
phycas.pdf_top_margin            = 1.0
phycas.pdf_bottom_margin         = 1.0
