...
# True  --> Beaglelib will be used to perform likelihood evaulations using GPU 
# False --> Beaglelib will not be used and likelihood evaluations will be done the standard way
use_gpu = False 
...
mcmc.nchains                    = 1
mcmc.ncycles                    = 20
mcmc.sample_every               = 20    # just once to make sure it's working
mcmc.report_every               = 21    # i.e. don't report
mcmc.adapt_first                = 21    # i.e. don't adapt
mcmc.verbose                    = True
...
if use_gpu:
    ...
    mcmc.out.log                    = 'gpu-codontest.txt'
    mcmc.out.params.prefix          = 'gpu-params'
    mcmc.out.trees.prefix           = 'gpu-trees'
else:
    mcmc.use_beaglelib              = False
    mcmc.out.log                    = 'cpu-codontest.txt'
    mcmc.out.params.prefix          = 'cpu-params'
    mcmc.out.trees.prefix           = 'cpu-trees'
