...
class MCMC(PhycasCommand):
    def __init__(self):
        args = tuple(
                ...
                ("starting_tree_source",   randomtree(),                    "A TreeCollection that will serve as the source of the starting tree topology. If a string is passed in, it is interpretted as a the path to a file with trees.", TreeSourceValidate),
