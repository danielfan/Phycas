 ...
 *
 * @version  $Revision: 1.1 $, $Date: 2004/10/18 02:59:38 $
 * @author   Leigh Brookshaw
 */

public class Graph2D extends JPanel { //Canvas {
 ...
 *********************/
   ...
   /**
    ...
    public void setBorderTop(int b) {
        borderTop = b;
    }
    /**
    ...
    public void setBorderBottom(int b) {
        borderBottom = b;
    }
    /**
    ...
    public void setBorderLeft(int b) {
        borderLeft = b;
    }
    /**
    ...
    public void setBorderRight(int b) {
        borderRight = b;
    }
    ...
    public void setDrawZero(boolean d) {
        drawzero = d;
    }
    /**
    ...
    public void setClearAll(boolean d) {
        clearAll = d;
    }
    /**
    ...
    public void setPaintAll(boolean d) {
        paintAll = d;
    }
 ...
 *******************/
    ...
    public void detachDataSet( DataSet d ) {
        if(d != null) {
            //if(d.getXAxis()) != null) 
                d.getXAxis().detachDataSet(d);
            //if(d.yaxis != null) 
                d.getYAxis().detachDataSet(d);
    ...
    public Axis createXAxis(  ) {
        Axis a = createAxis(Axis.BOTTOM);
        xAxis = a;
        return xAxis;
    }
    public Axis createYAxis(  ) {
        Axis a = createAxis(Axis.LEFT);
        yAxis = a;
        return yAxis;
    }
    ...
    public void detachAxes() {
        ...
        for (i=0; i<axis.size(); i++) {
            ...
            ((Axis)axis.elementAt(i)).setGraph(null);
        }
    ...
    public void paint(Graphics g) {
        ...
        if( !axis.isEmpty() ) 
            ...
            drawFrame(g2,r.x,r.y,r.width,r.height);
        }
        
        //paintBeforeData(lg,r);
        paintBeforeData(g2,r);
        ...
        if( !dataset.isEmpty() ) {
            ...
            for (i=0; i<dataset.size(); i++) {
                ...
                ((DataSet)dataset.elementAt(i)).draw_data(g2,r);
            }
        }
     ...
     *  @params g Graphics2D state
     *  @params r Rectangle containing the graph
     */
    public void paintFirst( Graphics2D g, Rectangle r) {
    }
     ...
     */
    public void paintBeforeData( Graphics2D g, Rectangle r) {
    }
     ...
     *  @params r Rectangle containing the data
     */
    public void paintLast( Graphics2D g, Rectangle r) {
        if( lastText != null ) {
 ...
 *******************/
     ...
     */
    protected Rectangle ForceSquare(Graphics2D g, Rectangle r) {
        Axis a;
        Rectangle dr;
        int x      = r.x;
        int y      = r.y;
 ...
 */
        for (int i=0; i<axis.size(); i++) {
            ...
            range = a.getMaximum() - a.getMinimum();
            if(a.isVertical()) {
        ...
        for (int i=0; i<axis.size(); i++) {
            a = (Axis)axis.elementAt(i);
            a.setMaximum(a.getMinimum() + range);
        }
/*
 ...
 */
    ...
    protected Rectangle getDataRectangle(Graphics2D g, Rectangle r) {
        Axis a;
        int waxis;
        int x     = r.x;
        int y     = r.y;
     ...
     */
    protected Rectangle drawAxis(Graphics2D g, Rectangle r) {
        Axis a;
        int waxis;
        Rectangle dr;
        int x;
        ...
        for (int i=0; i<axis.size(); i++) {
            ...
            a.setDataWindow(new Dimension(width,height));
            ...
            switch (a.getAxisPos()) {
                case Axis.LEFT:
                    ...
                    if(r.x == x ) {
                        a.setGridColor(gridcolor);
                        a.setDrawGrid(drawgrid);
                        a.setZeroColor(zerocolor);
                        a.setDrawZero(drawzero);
                    }
 ...
 */
    protected void drawFrame(Graphics2D g, int x, int y, int width, int height) {
        Color c = g.getColor();
...
class LoadMessage extends Thread {
    ...
    public void begin() {
        ...
        g2d.setClearAll(false);
        g2d.setPaintAll(false);
    ...
    public void end() {
        ...
        g2d.setClearAll(true);
        g2d.setPaintAll(true);
    ...
    public void run() {
        ...
        while(true) {
            ...
            if(lg == null) {
                lg = (Graphics2D)g2d.getGraphics();
                if(lg != null) 
                    lg = (Graphics2D)lg.create();
            }
