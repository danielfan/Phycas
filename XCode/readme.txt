...
You have to set a PYTHON_ROOT "source tree" in your XCode preferences so that
the project will find the correct version of python. This will be the path that
was used as the --prefix argument to python's configure.


You have to have BOOST_ROOT and NCL_ROOT correctly set as source trees as well.
