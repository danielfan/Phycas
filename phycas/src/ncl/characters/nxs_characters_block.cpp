...
#include "phycas/src/ncl/nxs_token.hpp"
#include "phycas/src/ncl/command/nxs_cmd_param.hpp" // needed because we have to check if commands have been read in HandleFormat
#include "phycas/src/ncl/misc/nxs_data_type_inl.hpp"
