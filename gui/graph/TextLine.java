...
*****************/
   ...
   */
     public FontMetrics getFM(Graphics2D g) {
   ...
   */
     public int charWidth(Graphics2D g, char ch) {
         FontMetrics fm;
         if(g==null) return 0;
   ...
   */
     public int getMaxAscent(Graphics2D g) {
         if(g == null) return 0;
   ...
   */
     public int getMaxDescent(Graphics2D g) {
         if(g == null) return 0;
   ...
   */
     public int getLeading(Graphics2D g) {
         if(g == null) return 0;
   ...
   */
     ...
     public void parseText(Graphics2D g) {
         FontMetrics fm;
