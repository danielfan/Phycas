...
class TreeManip(TreeManipBase):
    ...
    or rearrange the topology of an existing tree.    """    def __init__(self, t):        #---+----|----+----|----+----|----+----|----+----|----+----|----+----|        """        Constructs a TreeManip object that operates on the supplied tree t.
        ...
        (0) -> [5] -> (4) -> (3) -> (2) -> (1)
        """        TreeManipBase.__init__(self, t)            def starTree(self, num_tips, edge_len_dist):        #---+----|----+----|----+----|----+----|----+----|----+----|----+----|        """        Creates a star tree having num_tips tips and edge lengths drawn at
    ...
    def yuleTree(self, num_tips, rng, lambd):        #---+----|----+----|----+----|----+----|----+----|----+----|----+----|        """        Creates a Yule tree having num_tips tips, speciation rate lambd, and
    ...
    def randTree(self, num_tips, rng, edge_len_dist):        #---+----|----+----|----+----|----+----|----+----|----+----|----+----|        """        Creates a random tree topology having num_tips tips, with edge lengths
