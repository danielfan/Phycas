...
void model_pymod()
    ...
    class_<phycas::Binary, bases<phycas::Model> >("BinaryModelBase")
		...
		.def("fixRevForRateRatio", &phycas::Binary::fixRevForRateRatio)
		.def("freeRevForRateRatio", &phycas::Binary::freeRevForRateRatio)
		.def("getRevForRateRatio", &phycas::Binary::getRevForRateRatio)
		.def("setRevForRateRatio", &phycas::Binary::setRevForRateRatio)
