...
class MCMC(PhycasCommand):
    def __init__(self, p):
        args = (
                ...
                ("starting_kappa",         4.0,                             "The starting value for the kappa parameter in an HKY model", FloatArgValidate(min=0.01)),
                ...
                ("starting_shape",         0.5,                             "The starting value for the gamma shape parameter", FloatArgValidate(min=0.01)),
                ...
                ("estimate_pinvar",        False,                           "If True, an invariable sites submodel will be applied and the parameter representing the proportion of invariable sites will be estimated", BoolArgValidate),
                ("pinvar_prior",           BetaDist(1.0, 1.0),              "The prior distribution for pinvar, the proportion of invariable sites parameter"),
                ("starting_pinvar",        0.2,                             "The starting value of pinvar, the proportion of invariable sites parameter", ProbArgValidate()),
