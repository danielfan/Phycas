...
class MCMC(PhycasCommand):
    def __init__(self):
        args = tuple(
                ...
                ("starting_tree_source",   randomtree(),                      "Source of the starting tree topology: can be either 'random' or 'usertree'. Note that this setting does not determine the edge lengths in the starting tree, only the topology. Starting edge lengths are determined by the probability distribution specified in starting_edgelen_dist.", TreeSourceValidate),
