...
class JPG(PhycasCommand):
    def __init__(self):
        ...
        logf_spec = TextOutputSpec(prefix='jpgoutput', help_str="The file specified by this setting saves the console output generated by jpg(). If set to None, console output will not be saved to a file.")
