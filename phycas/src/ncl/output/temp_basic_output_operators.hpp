...
#include "phycas/src/ncl/misc/generic_type_mapping.hpp"
#include "phycas/src/ncl/misc/compile_assert.hpp"
...
#   include "phycas/src/ncl/output/nxs_sax_output_wrapper.hpp" 
#endif
template<class OBJ>
inline NxsOutputStreamWrapper & EmitGenericPlotLabels(NxsOutputStreamWrapper & out, const OBJ & obj)
	{
