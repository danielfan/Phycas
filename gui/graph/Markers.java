...
/*    public Markers(URL file) throws IOException {
    ...
    //VKJ
    public Markers(File file) throws IOException {
  ...
  /*  public void LoadMarkers(URL file) throws IOException {
    ...
    /**
     VKJ
     **/
    public void LoadMarkers(File file) throws IOException {
        InputStream is;
        StreamTokenizer st;
        MarkerVertex v;
     ...
     */
    public void draw(Graphics2D g, int m, double scale, int x, int y) {
        int i;
        MarkerVertex mv;
