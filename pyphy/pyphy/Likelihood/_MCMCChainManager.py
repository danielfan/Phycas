...
class MCMCChainManager(MCMCChainManagerBase):
    ...
    def addMCMCUpdaters(self, model, tree, like, rng, separate_edgelens, weight):
        """
        Sorry, no documentation yet.
        
        """
        return MCMCChainManagerBase.addMCMCUpdaters(self, model, tree, like, rng, separate_edgelens, weight)
