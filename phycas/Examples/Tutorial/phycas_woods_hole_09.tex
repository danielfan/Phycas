...
These can be set to True or False to toggle between the GTR or HKY models and between the steppingstone sampler versus normal MCMC.
...
We would like to thank Michael Cummings and the Workshop on Molecular Evolution for hosting the  \phycas lab. Funding sources include the CIPRES grant (NSF-DBI-0306047) to Dave Swofford, a NESCent sabbatical fellowship to Paul Lewis. 
