...
////////////////////////////////////////////////////////////////////////////////
    ...
    template <class ParentFunctor,
        typename PointerToMemFn>
    class TempMemFunHandler : public ParentFunctor::Impl
    {
        typedef typename ParentFunctor::Impl Base;
    ...
    public:
        ...
        TempMemFunHandler(PointerToMemFn pMemFn) 
        : pMemFn_(pMemFn)
        {}
        
        DEFINE_CLONE_FUNCTORIMPL(TempMemFunHandler)
        
        ResultType operator()(Parm1 p1)
        { return ((*p1).*pMemFn_)(); }
        
        ResultType operator()(Parm1 p1, Parm2 p2)
        { return ((*p1).*pMemFn_)(p2); }
        
        ResultType operator()(Parm1 p1, Parm2 p2, Parm3 p3)
        { return ((*p1).*pMemFn_)( p2, p3); }
        
        ResultType operator()(Parm1 p1, Parm2 p2, Parm3 p3, Parm4 p4)
        { return ((*p1).*pMemFn_)( p2, p3, p4); }
        
        ResultType operator()(Parm1 p1, Parm2 p2, Parm3 p3, Parm4 p4, Parm5 p5)
        { return ((*p1).*pMemFn_)( p2, p3, p4, p5); }
        
        ResultType operator()(Parm1 p1, Parm2 p2, Parm3 p3, Parm4 p4, Parm5 p5,
            Parm6 p6)
        { return ((*p1).*pMemFn_)( p2, p3, p4, p5, p6); }
        
        ResultType operator()(Parm1 p1, Parm2 p2, Parm3 p3, Parm4 p4, Parm5 p5,
            Parm6 p6, Parm7 p7)
        { return ((*p1).*pMemFn_)( p2, p3, p4, p5, p6, p7); }
        
        ResultType operator()(Parm1 p1, Parm2 p2, Parm3 p3, Parm4 p4, Parm5 p5,
            Parm6 p6, Parm7 p7, Parm8 p8)
        { return ((*p1).*pMemFn_)( p2, p3, p4, p5, p6, p7, p8); }
        
        ResultType operator()(Parm1 p1, Parm2 p2, Parm3 p3, Parm4 p4, Parm5 p5,
            Parm6 p6, Parm7 p7, Parm8 p8, Parm9 p9)
        { return ((*p1).*pMemFn_)( p2, p3, p4, p5, p6, p7, p8, p9); }
        
        ResultType operator()(Parm1 p1, Parm2 p2, Parm3 p3, Parm4 p4, Parm5 p5,
            Parm6 p6, Parm7 p7, Parm8 p8, Parm9 p9, Parm10 p10)
        { return ((*p1).*pMemFn_)( p2, p3, p4, p5, p6, p7, p8, p9, p10); }
...
#if MTH_TEMP_MEM_FUNC
		//@TEMP MTH trying to add member function in which the first param of every invocation of the () operatoris a pointer to the object
		template <typename MemFn>
        Functor(MemFn memFn, bool )
        : spImpl_(new TempMemFunHandler<Functor, MemFn>(memFn))
        {}
#endif
