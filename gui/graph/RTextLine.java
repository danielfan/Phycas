 ...
 *
 * @version $Revision: 1.1 $, $Date: 2004/10/18 02:59:12 $
...
*****************/
   ...
   */
     public int getRWidth(Graphics2D g) {
   ...
   */
     public int getRHeight(Graphics2D g) {
   ...
   * @return the Left edge of the rotated text
   */
     public int getLeftEdge(Graphics2D g) {
   ...
   * @return the Right edge of the rotated text
   */
     public int getRightEdge(Graphics2D g) {
   ...
   * @return the Top edge of the rotated text
   */
     public int getTopEdge(Graphics2D g) {
   ...
   * @return the Bottom edge of the rotated text
   */
     public int getBottomEdge(Graphics2D g) {
   ...
   * @return the Left edge of the rotated text
   */
     public int getLeftEdge(Graphics2D g, int j) {
   ...
   * @return the Right edge of the rotated text
   */
     public int getRightEdge(Graphics2D g, int j) {
   ...
   * @return the Top edge of the rotated text
   */
     public int getTopEdge(Graphics2D g, int j) {
   ...
   * @return the Bottom edge of the rotated text
   */
     public int getBottomEdge(Graphics2D g, int j) {
   ...
   */
     public void draw(Graphics2D g, int x, int y, int j) {
   ...
   * @param y pixel position of the text
   */
     public synchronized void draw(Component comp, Graphics2D g, int x, int y) {
         TextState ts;
         int xoffset = 0;
         int yoffset = 0;
         Image    offsI        = null;
         Graphics2D offsG        = null;
	 ...
	 */
         ...
         offsG = (Graphics2D)offsI.getGraphics();
	 /*
