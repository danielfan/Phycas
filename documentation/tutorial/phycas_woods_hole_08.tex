...
which are very sensitive to the prior over tree topologies?}{In most runs it the clade of:\\ ({\em Heterochlamydomonas rugosa} + {\em Heterochlamydomonas inaequalis})\\ and the clade leading to:\\ ({\em Volvox carteri}, {\em Chlamydomonas reinhardtii}, {\em Tetraspora sp}, {\em Chlamydomonas baca}, the three {\em Heterochlamydomonas} species, and {\em Carteria radiosa}, and {\em Carteria obtusa})\\ are the ones that you should pay extra attention to.}
...
\QandA{Do the results seem comparable to the other analyses?}{}
