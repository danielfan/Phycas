...
REM   1. Build both boost_python.dll and Phycas using dojam.py
...
copy /Y bin\boost\libs\python\build\boost_python.dll\vc-7_1\release\threading-multi\boost_python.dll phycas\Conversions
python setup.py bdist_wininst --target-version 2.5 --bitmap phycaslogo.bmp --install-script win_shortcuts.py
pause
