...
When you are using the Phycas.app bundle, you will not need to invoke Python and enter the \cmd{from phycas import *} command.
Essentially the application brings up a terminal window, and enters the commands \cmd{python} and \cmd{from phycas import *} for you.
Note that you {\bf will} have to use the import command in all of your \phycas scripts.
...
Locate the directory of example files labeled \localfile{phycasWoodsHole2009Demo} and move it to a convenient location for you.
...
Rather than type all of the commands in interactively, this exercise is best done by executing the script that is in the demo folder.
